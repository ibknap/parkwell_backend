    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_park_admin', models.BooleanField(default=False, verbose_name='Park admin')),
                ('photo', models.ImageField(blank=True, default='../static/avatar.png', null=True, upload_to='administrator_photos/', verbose_name="Administrator's photo(optional)")),
