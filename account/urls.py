...
urlpatterns = [
    ...
    path('admin_login/', views.AdminLoginAPI.as_view(), name='admin_login_api'),
    ...
    path('company_admin_profile/<int:user_id>/', views.CompanyAdminProfileDetail.as_view(), name='company_admin_profile_detail'),
    ...
    path('park_admin_profile/<int:user_id>/', views.ParkAdminProfileDetail.as_view(), name='park_admin_profile_detail'),
